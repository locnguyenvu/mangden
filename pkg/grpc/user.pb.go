...
var file_proto_user_proto_rawDesc = []byte{
	...
	0x63, 0x65, 0x12, 0x34, 0x0a, 0x03, 0x47, 0x65, 0x74, 0x12, 0x14, 0x2e, 0x75, 0x73, 0x65, 0x72,
	...
	0x73, 0x74, 0x1a, 0x18, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x41, 0x63,
...
var file_proto_user_proto_goTypes = []interface{}{
	...
	(*UserActionResponse)(nil), // 7: user.UserActionResponse
}
var file_proto_user_proto_depIdxs = []int32{
	1, // 0: user.ListUserResponse.data:type_name -> user.GetUserResponse
	0, // 1: user.UserService.Get:input_type -> user.GetUserRequest
	2, // 2: user.UserService.List:input_type -> user.ListUserRequest
	...
	1, // 6: user.UserService.Get:output_type -> user.GetUserResponse
	3, // 7: user.UserService.List:output_type -> user.ListUserResponse
	7, // 8: user.UserService.Create:output_type -> user.UserActionResponse
	7, // 9: user.UserService.Delete:output_type -> user.UserActionResponse
	7, // 10: user.UserService.Update:output_type -> user.UserActionResponse
